...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "find a licensed therapist in US",
    "trauma therapy",
    "relationship counselling Nigeria",
    "couples therapy Nigeria",
    "psychologist Nigeria",
    "affordable private therapy UK",
    "CBT therapy",
    "UK online therapists accepting new clients",
    "Uk marriage counsellor",
    "US online therapy sessions",
    "US Marriage counseling services",
    "Licensed mental health counselor",
    "Book virtual counseling US",
    "Couples counseling booking / Marriage therapy session",
    "mental wellness",
    "burnout recovery",
    "online counseling",
    "affordable therapy Nigeria",
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        ...
        {/* Google tag (gtag.js) */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-5XZJPSD2C2"
