...
// //
// // This page calls /api/paystack/verify which confirms the payment
// // with Paystack's servers before showing success or failure.
...
//                             Please wait while we verify your booking with our payment provider.
//                         </p>
//                     </div>
//                 </section>
//             </div>
...
//                     </div>
//                     <h2 className="font-cormorant text-3xl font-light mb-3" style={{ color: "var(--deep)" }}>
//                         {state === "invalid" ? "Invalid payment link" : "Payment not verified"}
//                     </h2>
//                     <p className="text-sm leading-relaxed mb-8" style={{ color: "var(--text-muted)" }}>
//                         {state === "invalid"
//                             ? "This payment link is not valid. Please return to the booking page and try again."
//                             : errorMsg || "We could not confirm your payment. If you were charged, please contact us immediately and we will resolve it."}
//                     </p>
...
//                         </Link>
//                         <a
//                             href="mailto:hello@trymentel.com"
...
// app/verify/page.tsx
//
// Paystack redirects here after popup payment as a fallback:
//   /verify?reference=MENTEL-xxx&trxref=MENTEL-xxx
//
// This page verifies the payment server-side then shows a
// confirmation screen — same experience as the popup onSuccess.
// Users who close the popup early also land here safely.
            ...
            <div className="relative min-h-screen">
                ...
                <section className="relative z-10 pt-24 pb-20 px-4 sm:px-6">
                    <div className="max-w-lg mx-auto animate-fade-up">
                        ...
                        {/* Hero */}
                        <div className="rounded-2xl sm:rounded-3xl p-8 sm:p-10 relative overflow-hidden mb-6 text-white text-center"
                            style={{ background: "linear-gradient(135deg, #4e7a5e, #3d8b8b)" }}>
                            ...
                            <div className="space-y-3">
                                {[
                                    ...
                                    <div key={label} className="flex items-start justify-between gap-4">
                                        ...
                                        <span className={`text-sm text-right ${mono ? "font-mono text-xs break-all" : "font-medium"}`}
                                            style={{ color: "var(--deep)" }}>{value}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
