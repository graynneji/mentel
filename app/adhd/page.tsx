...
// function loadCompletedPointer(): CompletedPointer | null {
//     if (typeof window === "undefined") return null;
//     try {
...
// function persistCompletedPointer(pointer: CompletedPointer) {
//     try {
...
//         router.push(`/adhd/result?leadId=${encodeURIComponent(completedAvailable.leadId)}`);
//     }
...
//                         <ClinicalTrustBar clinicallyReviewed={clinicallyReviewed} />
