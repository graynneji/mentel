        ...
        <div className="relative">
            ...
            <div className="relative z-10 max-w-3xl mx-auto px-6 pt-28 pb-20">
                ...
                <div className="max-w-xl mb-14">
                    ...
                    <p className="text-base font-light leading-relaxed" style={{ color: "var(--text-muted)" }}>
                        Last updated: July 2026. Please read these terms carefully before using Mentel.
                    </p>
                </div>
                ...
                >
                    ...
                    <p className="text-sm" style={{ color: "var(--text-muted)" }}>
                        Reach us at{" "}
                        <a href="mailto:hello@mail.trymentel.com" className="underline underline-offset-2" style={{ color: "var(--teal)" }}>
