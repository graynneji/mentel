...
const contactInfo = [
    ...
    { icon: Phone, label: "Phone - WhatsApp only", value: "+234 703 136 2034", href: "tel:+234 703 136 2034" },
    { icon: MapPin, label: "Location", value: "Lagos, Nigeria", href: "#" },
];

const socials = [
    // { icon: WhatsAppIcon, label: "WhatsApp", href: "https://wa.me/+254734527573" },
    { icon: WhatsAppIcon, label: "WhatsApp", href: "https://wa.me/+2347031362034" },
    { icon: FacebookIcon, label: "Facebook", href: "https://www.facebook.com/profile.php?id=61589294892050" },
