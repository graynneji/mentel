...
// const ROLES = [
//     "Licensed Therapist / Clinical Professional",
    ...
    async function handleFile(e: React.ChangeEvent<HTMLInputElement>) {
        ...
        try {
            ...
            const res = await fetch(
                "/api/volunteer-verification/upload",
                {
                    method: "POST",
                    body,
                }
        ...
        <div>
            ...
            {value ? (
                ...
                >
                    ...
                    {uploading
                        ? "Uploading…"
                        : "Click to upload (PDF, DOC, or image, max 8MB)"}
...
export default function ProfessionalApplicationPage() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        if (!form.role) {
            nextErrors.role = "Please select the role you're applying for.";
        }

        if (!/^\d{11}$/.test(form.ninNumber.trim())) {
            nextErrors.ninNumber =
                "Please enter a valid 11-digit NIN.";
        }

        if (!form.cvDocumentUrl) {
            nextErrors.cvDocumentUrl =
        ...
        if (
            ...
            nextErrors.licenseBody =
                "Please select your licensing body.";
        }
    ...
    return (
        <div
            ...
            style={{ background: "var(--bg, #fbfdfc)" }}
        >
                    ...
                    {sent ? (
                        <div className="text-center py-16 animate-fade-up">
                            ...
                            >
                                ...
                                working with Mentel. Our team will
                                review your application and supporting
                                documents and get back to you at{" "}
                        ...
                        <>
                            <div className="text-center mb-10">
                                ...
                                <h1
                                    className="font-cormorant text-3xl md:text-4xl font-light mb-3"
                                    style={{
                                        color: "var(--deep)",
                                    }}
                                >
                                    Apply to work with Mentel
                                </h1>
                                ...
                                >
                                    ...
                                    team. Complete this application
                                    with your details, CV, and
                                    professional credentials where
                                    applicable.
                                </p>
                            </div>
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        background:
                                            "linear-gradient(90deg, var(--sage), var(--teal), var(--sage-light))",
                                    }}
                                />
                                ...
                                >
                                    <div className="grid md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                className={`form-input ${errors.fullName
                                                    ? "form-input-error"
                                                    : ""
                                                    }`}
                                                value={form.fullName}
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                type="tel"
                                                className={`form-input ${errors.phone
                                                    ? "form-input-error"
                                                    : ""
                                                    }`}
                                                value={form.phone}
                                        ...
                                        <div>
                                            ...
                                            <input
                                                className={`form-input ${errors.city
                                                    ? "form-input-error"
                                                    : ""
                                                    }`}
                                                value={form.city}
                                    ...
                                    >
                                        <label
                                            className="block text-xs font-medium uppercase tracking-widest mb-2 mt-4"
                                            style={{
                                                color: "var(--text-muted)",
                                            }}
                                        >
                                        ...
                                        >
                                            <div className="grid md:grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <select
                                                        className={`form-input ${errors.licenseBody
                                                            ? "form-input-error"
                                                            : ""
                                                            }`}
                                                        value={
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder="e.g. AHPCN/2024/00123"
                                                    />
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        className="pt-2 border-t flex flex-col gap-4"
                                        style={{
                                            borderColor: "var(--border)",
                                        }}
                                    >
                                        <p
                                            className="text-xs font-medium uppercase tracking-widest mt-4"
                                            style={{
                                                color: "var(--text-muted)",
                                            }}
                                        >
                                        ...
                                        <div>
                                            ...
                                            <input
                                                inputMode="numeric"
                                                maxLength={11}
                                                className={`form-input ${errors.ninNumber
                                                    ? "form-input-error"
                                                    : ""
                                                    }`}
                                            ...
                                            >
                                                Your NIN is used for identity
                                                verification only and is kept
                                        ...
                                        <DocumentUpload
                                            ...
                                            hint="Optional, but may help us complete verification faster."
                                            kind="nin"
