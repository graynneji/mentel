...
interface FlutterwaveCheckoutProps {
    ...
    onSuccess: (transactionRef: string) => void;
    onClose?: () => void;
    /** Fired right before Flutterwave's modal opens, with the freshly-minted
     * tx_ref. Intentionally generic (no tracking calls live in this shared
     * component itself) — callers use this to fire their own
     * flow-specific analytics (e.g. an InitiateCheckout conversion event)
     * without this component needing to know what flow it's embedded in. */
    onOpen?: (transactionRef: string) => void;
    className?: string;
    children?: React.ReactNode;
}
