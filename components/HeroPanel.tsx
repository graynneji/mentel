...
export default function HeroPanel() {
    ...
    return (
        <>
            {/* Single card — both views live inside, one visible at a time */}
            <div
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        />
                        Single session — ₦10,000 limited offer
                    </div>
                    ...
                    {/* Social proof */}
                    <div
                        className="flex items-center gap-3 mb-7 pb-6 border-b"
                        style={{ borderColor: "rgba(123,169,139,0.15)" }}
                    >
                        ...
                        <div>
                            ...
                            <p className="text-xs" style={{ color: "var(--text-muted)" }}>
                                Trusted by 500+ clients across Nigeria
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-7">
                        {microTrust.map(({ icon: Icon, label, sub }) => (
                            <div
                                ...
                                style={{
                                    background: "rgba(123,169,139,0.05)",
                                    border: "1px solid rgba(123,169,139,0.12)",
                                }}
                            >
                                <Icon size={14} style={{ color: "var(--sage-dark)" }} />
                                <span className="text-xs font-medium leading-tight" style={{ color: "var(--deep)" }}>
                                    {label}
                                </span>
                                <span style={{ color: "var(--text-muted)", fontSize: "10px" }} className="leading-tight">
                                    {sub}
                                </span>
                            </div>
                        ))}
            ...
            {/* Assessment nudge — always visible below */}
            <div
                style={{
