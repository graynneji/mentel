...
const WHATSAPP_NUMBER = "2348000000000"; // ← replace with your actual number
...
export default function EAPSection() {
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        if (!name || !email || !size) return;

        // Build the WhatsApp message from form values
        const message = [
            `Hi, I'd like to request a Mentel EAP demo.`,
            ``,
            `Name: ${name}`,
            `Email: ${email}`,
            `Team size: ${size}`,
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="flex flex-col lg:flex-row lg:items-start gap-12">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm leading-relaxed mb-8" style={{ color: "rgba(200,221,210,0.8)", maxWidth: "500px" }}>
                            Companies lose billions annually to burnout, absenteeism, and low engagement.
                            Mentel EAP gives your employees confidential access to licensed therapists and
                            gives HR the anonymised insights to build a healthier organisation.
                        </p>
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-4 flex-wrap">
                                {["Fintech startup", "Student communities", "Remote teams"].map((name) => (
                                    // {["Techpoint Africa", "Flutterwave Ecosystem", "Lagos Startups"].map((name) => (
                                    <span
                                        key={name}
                                        className="text-xs font-medium px-3 py-1.5 rounded-full border"
                    ...
                    >
                        {submitted ? (
                            ...
                            <div className="flex flex-col items-center text-center py-6 gap-4">
                                ...
                                <p className="text-sm font-medium text-white">WhatsApp is opening…</p>
                                <p className="text-xs" style={{ color: "rgba(200,221,210,0.7)" }}>
                                    Your details have been pre-filled in the message. Just hit send and
                            ...
                            <>
                                ...
                                <p className="text-xs mb-6" style={{ color: "rgba(200,221,210,0.65)" }}>
                                    Fill in your details and we&apos;ll open a WhatsApp chat with everything
                                    pre-filled — no forms, no waiting.
                                </p>
                                ...
                                <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                                    ...
                                    <button
                                        ...
                                        className="mt-2 w-full flex items-center justify-center gap-2 text-sm font-medium text-white py-3 rounded-full transition-all hover:opacity-90 disabled:opacity-40 disabled:cursor-not-allowed"
                                        style={{ background: "linear-gradient(135deg, #4e7a5e, #3d8b8b)" }}
                                    >
                                ...
                                <div className="mt-4 pt-4 border-t" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
                                    <p className="text-xs text-center" style={{ color: "rgba(200,221,210,0.4)" }}>
                                        ...
                                        <a
                                            ...
                                            style={{ color: "rgba(200,221,210,0.55)" }}
                                        >
                                            hello@trymentel.com
                                        </a>
                                    </p>
