...
/**
 * BottomCTA — fixed version.
 *
 * Bug in original: scrollToBooking() scrolled to #book which doesn't exist.
 * Fix: uses openBooking() from BookingContext, same as Navbar and HeroPanel.
 *
 * Usage: drop-in replacement for the original BottomCTA.tsx
 */
